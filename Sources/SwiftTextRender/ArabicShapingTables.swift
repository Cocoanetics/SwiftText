//  ArabicShapingTables.swift
//  SwiftTextRender
//
//  Generated from Python `unicodedata` (Unicode Arabic Presentation Forms-A/B):
//  each letter's forms are read from the compatibility decompositions tagged
//  <isolated>/<final>/<initial>/<medial>, and the lam-alef ligatures from the
//  <isolated>/<final> two-character decompositions whose second base is an alef
//  variant. Do not edit by hand — regenerate if Unicode adds letters.

import Foundation

/// base scalar → (isolated, final, initial, medial) presentation forms.
/// A 0 means that form is not defined for the letter (e.g. a right-joining
/// letter has no initial/medial form).
let arabicPresentationForms: [UInt32: (isolated: UInt32, final: UInt32, initial: UInt32, medial: UInt32)] = [
...
let arabicLamAlef: [UInt32: (isolated: UInt32, final: UInt32)] = [
